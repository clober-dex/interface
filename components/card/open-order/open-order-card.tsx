      ...
      <div className="h-[58px] w-full relative hidden text-white xl:flex px-4 bg-transparent justify-start items-center gap-[3px]">
        ...
        <div className="flex ml-auto">
          <div className="h-full ml-auto justify-center items-center gap-3 flex">
            <ActionButton
              {...claimActionButtonProps}
              className="disabled:text-gray-400 disabled:bg-[#2b3544] w-[99px] h-8 px-3 py-2 bg-blue-400/25 rounded-[10px] inline-flex justify-center items-center gap-1 flex-1 opacity-90 text-center text-[#86c0ff] text-sm font-semibold leading-tight"
            >
              Claim
            </ActionButton>
            <ActionButton
