...
export const PageSelector = () => {
  ...
  return (
    <div className="absolute -left-8 top-4 md:top-10 z-[1500] flex flex-col bg-[#151517] border border-solid border-gray-700 rounded-xl p-1 items-start shadow-[4px_4px_12px_12px_rgba(0,0,0,0.15)]">
      <div className="flex flex-col items-start self-stretch rounded-none">
        <div className="flex flex-col gap-1 items-start self-stretch rounded-none">
